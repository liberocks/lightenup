...
@RoutePage()
class DoctorAssignmentFactOrOpinionTemplateScreen extends StatefulWidget {
  const DoctorAssignmentFactOrOpinionTemplateScreen({
  ...
  @override
  State<DoctorAssignmentFactOrOpinionTemplateScreen> createState() =>
      _DoctorAssignmentFactOrOpinionTemplateScreenState();
}

class _DoctorAssignmentFactOrOpinionTemplateScreenState
    extends State<DoctorAssignmentFactOrOpinionTemplateScreen> {
