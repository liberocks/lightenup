...
@RoutePage()
class DoctorAssignmentSocraticQuestionsTemplateScreen extends StatefulWidget {
  const DoctorAssignmentSocraticQuestionsTemplateScreen({
  ...
  @override
  State<DoctorAssignmentSocraticQuestionsTemplateScreen> createState() =>
      _DoctorAssignmentSocraticQuestionsTemplateScreenState();
}

class _DoctorAssignmentSocraticQuestionsTemplateScreenState
    extends State<DoctorAssignmentSocraticQuestionsTemplateScreen> {
